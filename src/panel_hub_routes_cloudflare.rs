...
use crate::panel_hub_pages_cloudflare_pager::manage_list_url;
use crate::panel_hub_routes_cloudflare_forms::{
    CfAddForm, CfDomainForm, CfProxyForm, CfQuery, CfRecordForm, CfUpdateForm, manage_back,
    opts_from_form, parse_optional_u16, table_opts_from_query,
};
...
pub async fn cloudflare_dns_get(
    ...
    {
        let mut loc = manage_list_url(&preferred, &table_opts);
