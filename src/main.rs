...
use cpn_installer::panel_hub_routes::{
    ...
    settings_site_messages_save, settings_error_messages_page, settings_error_messages_preview,
    ...
    settings_error_messages_save, settings_version_page, sidebar_acl_delete_post, sidebar_acl_get,
    sidebar_acl_post, site_filemanager_alias, site_files_op,
...
async fn main() -> std::io::Result<()> {
    ...
    let mut server = HttpServer::new(move || {
        App::new()
            ...
            .service(cpn_installer::maintenance_api::api_version_source_set)
