...
fn gauge_stroke_for_usage(percent: u8) -> &'static str {
    if percent >= 85 {
        "#d92d20" // red: almost full / need capacity
    } else if percent >= 60 {
        "#f79009" // orange: medium / getting full
    } else {
        "#12b76a" // green: good / low usage
    }
}
...
<body>
  ...
  {script}
        ...
        styles = format!("{}{}", panel_styles(), crate::panel_hubs::hub_styles()),
