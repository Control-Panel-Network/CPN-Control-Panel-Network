...
const es: LocaleMessages = {
  ...
  maintenanceUpdateAvailable: 'Instalado {installed}. Hay una versión más nueva: {latest}.',
  maintenanceUpToDate: 'Versión instalada {version}. No hay una estable más nueva.',
  maintenanceChooseVersion: 'Versión / etiqueta',
  maintenanceConfirmDowngrade: 'Entiendo que esto bajará a una versión anterior.',
