...
This Code of Conduct applies within all CPN community spaces, and also applies
when an individual is officially representing the community in public spaces.
Examples of representing our community include using an official project e-mail
address, posting via an official social media account, or acting as an appointed
representative at an online or offline event.

Community spaces include GitHub issues, pull requests, discussions, and other
channels used for CPN (Control Panel Network).
